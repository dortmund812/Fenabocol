		...
		<div class="row">
			...
			<div class="barra-lateral col-12 col-sm-auto">
				...
				<nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
					<!-- JUGADAS ASIGNADAS -->
					<a class="menu-opcion seleccionado" id="registrar_jugadas" target="principal" href="../../SI/bingoFenabocol/jugadasAsignadas/jugadasAsignadas.php">
						<i class="icon-assignment_turned_in"></i><span>Jugadas Asignadas</span>
					</a>
					<!-- REGISTAR JUGADAS -->
					<a class="menu-opcion" id="registrar_jugadas" target="principal" href="../../SI/bingoFenabocol/registrarJugadas/jugadas.php">
						<i class="icon-edit"></i><span>Registrar Jugadas</span>
					</a>
					<!-- MIS JUGADAS -->
					<a class="menu-opcion" id="mis_jugadas" target="principal" href="../../SI/bingoFenabocol/misJugadas/jugadas.php">
						<i class="icon-format_list_bulleted"></i><span>Mis Jugadas</span>
					</a>
					<!-- CONFIGURACION -->
					<a class="menu-opcion" id="configuracion" target="principal" href="../../SI/bingoFenabocol/configuracion/configuracion.php">
								...
								<div id="collapse3">
									...
									<div class="card card-body p-0">
										<div id="accordion-eventos" style="height: 89vh">
											<iframe id="principal" title="principal" name="principal" class="w-100" height="100%" src="../../SI/bingoFenabocol/jugadasAsignadas/jugadasAsignadas.php" frameborder="0"></iframe>
										</div>
									</div>
								</div>
							</div>
