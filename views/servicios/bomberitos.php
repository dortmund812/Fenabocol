				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown active">
						...
						<div class="dropdown-menu" aria-labelledby="navbarServicios">
							...
							<a class="dropdown-item" href="bomberitos.php">Bomberitos</a>
							<a class="dropdown-item" href="programa-ambiental.php">Programa ambiental</a>
					...
					<!-- GANACOL -->
					<li class="nav-item">
						<a class="nav-link text-white" href="../ganacol/">Ganacol</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-12 col-md-8 contenido-principal">
				...
				<div class="card contenedor-info">
					<div class="card-body">
						<h1 class="titulo">Bomberitos</h1>
						<hr>
						<p class="card-text mb-4">
							En <strong>Fenabocol ORG</strong>, contamos con un curso el cual está enfocado para los niños residentes en nuestro país, para sembrar y estimular en estos niños valores cívicos y altruistas para formar personas de bien común que podrán servir a su comunidad y al País.
						</p>
						<div class="swiper-container">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<img src="../../img/kids-2595698_1920.jpg" alt="" class="w-100 h-100">
								</div>
								<div class="swiper-slide">
									<img src="../../img/firefighter-4025841_1920.jpg" alt="" class="w-100 h-100">
								</div>
								<div class="swiper-slide">
									<img src="../../img/Bomberitos.jpg" alt="" class="w-100 h-100">
								</div>
								<div class="swiper-slide">
									<img src="../../img/bear-3904061_1920.jpg" alt="" class="w-100 h-100">
								</div>
								<div class="swiper-slide">
									<img src="../../img/deqojx3waaeoren.jpg" alt="" class="w-100 h-100">
								</div>
							</div>
							<!-- Add Pagination -->
