		...
		<div class="row">
			...
			<div class="col-12 col-md-8 contenido-principal">
				...
				<div class="card contenedor-info">
					<div class="card-body">
						<h1 class="titulo">Programa Ambiental</h1>
						<hr>
						<p class="card-text">
							Aqui en <strong>Fenabocol ORG</strong> promovemos el buen uso y cuidado del medio ambiente, es por ello que te invitamos a hacer parte de estas buenas practicas con <strong>Fenabocol ORG</strong>.
						</p>
						<img src="../../img/medio-ambiente.jpg" alt="" class="w-100">
					</div>
				</div>
			</div>
			<!-- CONTENIDO LATERAL -->
