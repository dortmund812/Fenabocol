		...
		<div class="row">
			...
			<div class="barra-lateral col-12 col-sm-auto">
				...
				<nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
					<!-- REGISTAR JUGADAS -->
					<a class="menu-opcion seleccionado" id="registrar_jugadas" target="principal" href="../../SI/voluntario/juego/juego.php">
						<i class="icon-edit"></i><span>Jugar</span>
					</a>
					<!-- CONFIGURACION -->
					<a class="menu-opcion" id="mis_jugadas" target="principal" href="../../SI/voluntario/configuracion/configuracion.php">
								...
								<div id="collapse3">
									...
									<div class="card card-body p-0">
										<div id="accordion-eventos" style="height: 89vh">
											<iframe id="principal" title="principal" name="principal" class="w-100" height="100%" src="../../SI/voluntario/juego/juego.php" frameborder="0"></iframe>
										</div>
									</div>
								</div>
							</div>
