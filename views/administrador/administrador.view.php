		...
		<div class="row">
			...
			<div class="barra-lateral col-12 col-sm-auto">
				...
				<nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
					<!-- REGISTAR JUGADAS -->
					<a class="menu-opcion seleccionado" id="registrar_jugadas" target="principal" href="../../SI/administrador/crearJuego/crearJuego.php">
						<i class="icon-edit"></i><span>Crear Juego</span>
					</a>
					<!-- ASIGNAR JUGADAS -->
					<a class="menu-opcion" id="registrar_jugadas" target="principal" href="../../SI/administrador/asignarJugadas/asignarJugadas.php">
						<i class="icon-content_paste"></i><span>Asignar Jugadas</span>
					</a>
					<!-- MIS JUGADAS -->
					<a class="menu-opcion" id="mis_jugadas" target="principal" href="../../SI/administrador/revisarJugadas/revisarJugadas.php">
						<i class="icon-format_list_bulleted"></i><span>Revisar Jugadas</span>
					</a>
					<!-- JUGADA FINAL -->
					<a class="menu-opcion" id="" target="principal" href="../../SI/administrador/jugadasFinales/jugadas.php">
						<i class="icon-library_add_check"></i><span>Juegos Realizados</span>
					</a>
					<!-- VOLUNTARIOS -->
					<a class="menu-opcion" id="" target="principal" href="../../SI/administrador/voluntarios/voluntarios.php">
						<i class="icon-users"></i><span>Voluntarios</span>
					</a>
					<!-- JUEGO RAPIDO -->
					<a class="menu-opcion" id="" target="principal" href="../../SI/administrador/juegoRapido/juegoRapido.php">
						<i class="icon-users"></i><span>Juego Rapido</span>
					</a>
					<!-- REGISTAR JUGADA -->
					<a class="menu-opcion" id="" target="principal" href="../../SI/administrador/registrarJugada/registrarJugada.php">
						<i class="icon-users"></i><span>Registrar Jugada</span>
					</a>
					<!-- CONFIGURACION -->
					<a class="menu-opcion" id="" target="principal" href="../../SI/administrador/configuracion/configuracion.php">
								...
								<div id="collapse3">
									...
									<div class="card card-body p-0">
										<div id="accordion-eventos" style="height: 89vh">
											<iframe id="principal" title="principal" name="principal" class="w-100" height="100%" src="../../SI/administrador/crearJuego/crearJuego.php" frameborder="0"></iframe>
										</div>
									</div>
								</div>
							</div>
